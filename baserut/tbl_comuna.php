...
INNER JOIN telefonos C ON PP.rut = C.rut 
  WHERE PP.comuna LIKE '%$comuna%' AND ( A.rut <= $rutmayor AND A.rut>=$rutmenor)";
...
<body class="center">
    <div class="row">
     ...
     <img src="logo_binter.jpeg" width="350" height="180">
        ...
        <br>   <br>   <br>
          <form method="post" class="form" action="reporte_comuna.php">
      
         <input type="number"  class="text-center hide" id="rutmenor" name="rutmenor" required="required" value=<?php echo $rutmenor ?> /> 
          <input type="number" class="text-center hide"  id="rutmayor" name="rutmayor"  required="required"value=<?php echo $rutmayor ?> />    <br>
          <input type="text" class="text-center hide" id="comuna1" name="comuna1"  required="required"value=<?php echo $comuna ?> />    <br>
